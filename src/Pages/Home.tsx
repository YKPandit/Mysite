    ...
    return (
        <>
            <div className="flex flex-col-2 gap-8 w-auto">
                <div className="w-1/2 bg-[#252525] position relative top-8 py-20 px-5 drop-shadow-md text-white resize-none sm:resize rounded-lg transition-all duration-300 hover:scale-110">
            ...
            <div className="flex flex-col-2 gap-8 w-full">
                <div className="w-1/2 bg-[#252525] position relative top-16 py-20 px-5 drop-shadow-md text-white resize-none sm:resize rounded-lg transition-all duration-300 hover:scale-110">
